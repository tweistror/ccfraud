...
# x_ben, x_fraud = get_data_paysim("paysim.csv", positive_samples=positive_samples, verbosity=1)
# x_ben = sample_shuffle(x_ben)
# np.save('x_ben.npy', x_ben)
# np.save('x_fraud.npy', x_fraud)

x_ben = np.load('./debug/paysim/x_ben.npy')
x_fraud = np.load('./debug/paysim/x_fraud.npy')
